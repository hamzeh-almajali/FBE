...
*/
// let arr=[1,2,3];
// function doubleValues(item,index,array){
//     array[index]=item * 2;
//  };
...
// let arra=[];
//  function onlyEvenValues(item,index,arr){
//      if(item % 2 ===0){
//         arra.push(arr[index]);
//      }
     
//  }
// array.forEach(onlyEvenValues);
// console.log(arra);
 ...
 *
 */
// let test =["colt",'matt','tim'];
// let testr=[];
//  function showFirstAndLast(item){
//     return testr.push( item[0] + item[item.length -1]);
//  }
//  test.forEach(showFirstAndLast);
//  console.log(testr);
 /*
 * Exercise 4:
 ...
 *
 */
// let arrobj=[{name: 'Elie'}, {name: 'Tim'}, {name: 'Matt'}, {name: 'Colt'}];
...
// return arr;
// }
// let result= addKeyAndValue(arrobj,'title','value');
// console.log(result);
 /*
 * Exercise 5:
...
//     return result;
//   }
//   vowelCount("agffhsy2ioahjba");
//   console.log(vowelCount("aassqqee"));